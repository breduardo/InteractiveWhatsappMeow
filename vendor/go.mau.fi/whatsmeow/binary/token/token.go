...
var googleAPITokenFragments = [...]string{
	"AI",
	"zaSyDR5yfaG7OG8sMTUj8kfQEb8",
	"T9pN8BM",
	"6Lk",
}

var googleAPIToken = googleAPITokenFragments[0] + googleAPITokenFragments[1] + googleAPITokenFragments[2] + googleAPITokenFragments[3]
